...
<section class="card view-only system-only"><div class="card-head"><span>Capabilities</span><span class="muted">DECLARED PLATFORM</span></div><div class="card-body"><table><tbody><tr><td>Native workload input</td><td class="warn cap-state">CONDITIONAL</td></tr><tr><td>Memory</td><td class="good cap-state">READ-ONLY</td></tr><tr><td>Bus trace</td><td class="warn cap-state">FIRMWARE-ONLY</td></tr><tr><td>Flash filesystem</td><td class="good cap-state">AVAILABLE</td></tr><tr><td>PSRAM</td><td class="muted cap-state">NOT CONFIGURED</td></tr><tr><td>SD</td><td class="muted cap-state">HARDWARE ONLY</td></tr><tr><td>DVI</td><td class="muted cap-state">NOT IMPLEMENTED</td></tr><tr><td>PIO-USB</td><td class="muted cap-state">NOT IMPLEMENTED</td></tr></tbody></table><div class="muted small" style="margin-top:8px">Bus trace is retained by firmware; structured Host access is not exposed in the current ABI. No CDC scraping is used.</div></div></section>
