...
typedef enum {
    RP86_PROCESSOR_BUS_CYCLE_MEM_READ = 0,
    RP86_PROCESSOR_BUS_CYCLE_MEM_WRITE = 1,
    RP86_PROCESSOR_BUS_CYCLE_IO_READ = 2,
    RP86_PROCESSOR_BUS_CYCLE_IO_WRITE = 3,
    RP86_PROCESSOR_BUS_CYCLE_INTERRUPT_ACK = 4,
    RP86_PROCESSOR_BUS_CYCLE_UNSUPPORTED = 5,
