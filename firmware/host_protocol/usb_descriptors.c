...
static const tusb_desc_device_t device_descriptor = {
    ...
    .idVendor = RP86_HOST_PROTOCOL_USB_VID,
    .idProduct = RP86_HOST_PROTOCOL_USB_PID,
    .bcdDevice = 0x0100,
...
static const uint8_t hid_report_descriptor[] = {
    TUD_HID_REPORT_DESC_GENERIC_INOUT(RP86_HOST_PROTOCOL_MESSAGE_SIZE)
};
...
static const uint8_t configuration_descriptor[] = {
    ...
    TUD_HID_INOUT_DESCRIPTOR(ITF_NUM_HID, STRID_HID, HID_ITF_PROTOCOL_NONE,
                             ...
                             EPNUM_HID_IN, RP86_HOST_PROTOCOL_MESSAGE_SIZE, 1),
};
...
const uint16_t *tud_descriptor_string_cb(uint8_t index, uint16_t language_id) {
    ...
    if (index == STRID_SERIAL) {
        ...
        text = RP86_HOST_PROTOCOL_USB_PRODUCT;
