...
typedef enum {
    RP86_WORKLOAD_CLOCK_AUTO = 0,
    RP86_WORKLOAD_CLOCK_FREE_RUNNING = 1,
    RP86_WORKLOAD_CLOCK_STEPPED = 2,
    RP86_WORKLOAD_CLOCK_STOPPED = 3,
} rp86_workload_clock_mode_t;
...
typedef enum {
    ...
    RP86_WORKLOAD_STATE_COMPLETED = 5,
