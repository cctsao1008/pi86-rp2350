...
separate. See [`build_and_toolchain.md`](../development/build_and_toolchain.md).
...
```powershell
py -m host.apps.cli.rp86 --interactive --attach `
...
See [`recovery.md`](recovery.md) for USB, flashing, and runtime recovery.
