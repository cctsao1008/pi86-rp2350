...
3. Keep validation evidence, ADRs, release records, and project stories outside
   the archive unless their own authority model explicitly changes.
...
| [`completed-plans/native_bios_architecture.md`](completed-plans/native_bios_architecture.md) | Early Native BIOS direction | BIOS as an optional machine profile |
| [`completed-plans/minimal_pc_compatibility_matrix.md`](completed-plans/minimal_pc_compatibility_matrix.md) | PC-first compatibility roadmap | PC compatibility as an optional machine profile |
