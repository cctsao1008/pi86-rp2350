...
```text
py -m host.apps.cli.rp86 --start-workload build-freertos-system/workloads/FREERTOS-SYSTEM.P86W
```
...
```text
py -m tools.diagnostics.freertos_status \
...
```text
py -m host.apps.cli.rp86 --physical-regression <workload.P86W>
```
