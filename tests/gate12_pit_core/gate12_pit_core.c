...
int main(void) {
    ...
    printf("\nGate 12 PIT/PIC core validation\n");
    ...
    printf("\nGATE 12 PIT/PIC CORE RESULT: %s\n", pass ? "PASS" : "FAIL");
    printf("Physical V30 OUT 43h/40h -> PIT -> PIC -> INTA/IVT/ISR/EOI/IRET remains required before Gate 12 can be marked PASS.\n");
    fflush(stdout);
